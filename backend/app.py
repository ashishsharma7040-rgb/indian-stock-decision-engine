...
def live_debug_payload() -> dict[str, Any]:
    ...
    if attempted_password_modes == ["raw"]:
        likely_blockers.append("Only raw password mode was tried. If your broker setup expects a hashed password, set SHOONYA_PASSWORD_MODE=auto on Render and redeploy.")
