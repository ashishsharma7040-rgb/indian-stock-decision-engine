...
3. Event strength: sentiment x freshness x source reliability x importance. Weekly scoring uses faster freshness decay; monthly scoring keeps relevant events alive longer.
