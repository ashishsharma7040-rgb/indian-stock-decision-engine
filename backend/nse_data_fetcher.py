...
class NSEDataFetcher:
    ...
    def bhavcopy_payload(self, target_date: date | None = None) -> dict[str, Any]:
        ...
        for raw_row in df.to_dict("records"):
            ...
            delivery_qty = _clean_float(_pick(raw_row, ["DELIV_QTY", "DELIVERY_QTY", "DeliverableQty", "DELIVERY_QUANTITY"]))
            delivery_pct = _clean_float(_pick(raw_row, ["DELIV_PER", "DELIVERY_PCT", "DeliverablePercent", "DELIVERY_PERCENTAGE"]))
