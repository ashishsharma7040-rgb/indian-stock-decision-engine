...
class LiveFeedManager:
    ...
    def _credential_diagnostics(self) -> dict[str, Any]:
        ...
        diagnostics["password_mode_setting"] = str(os.getenv("SHOONYA_PASSWORD_MODE", "auto")).strip().lower() or "auto"
        return diagnostics
    ...
    def _password_attempts(self) -> list[tuple[str, str]]:
        ...
        mode = str(os.getenv("SHOONYA_PASSWORD_MODE", "auto")).strip().lower() or "auto"
            ...
            for host, websocket in self._endpoint_candidates():
                for password_mode, password_value in self._password_attempts():
                    ...
                    with self._lock:
                        ...
                        if password_mode not in self._attempted_password_modes:
