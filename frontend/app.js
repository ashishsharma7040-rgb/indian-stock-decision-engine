...
async function submitShoonyaOtp() {
  ...
  try {
    ...
    setSettingsFeedback(message, payload.feed_open ? "blue" : "amber");
    qs("offlineNotice").textContent = payload.feed_open
      ? "Shoonya feed is live."
      : `${message} Waiting for login / websocket confirmation...`;
