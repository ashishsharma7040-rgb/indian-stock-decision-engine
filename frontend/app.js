  ...
  qs("stockView").innerHTML = `
    <div class="stock-head">
      <div>
        ...
        <div class="status-line">Weekly ${full.weekly_score} | Monthly ${full.monthly_score} | ${full.conviction} | State ${full.trade_state?.state || "Screened"} | Candidate ${full.candidate ? "Yes" : "No"}</div>
