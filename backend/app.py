...
def build_full_nse_scan_payload(scan_limit: Any = "all", force: bool = False) -> dict[str, Any]:
    ...
    try:
                    ...
                    if done_count % 5 == 0 or done_count == total_rows:
                        ...
                        set_full_scan_status(
                            ...
                            scan_meta={
                                ...
                                "proxy_so_far": sum(1 for item in all_scored if item.get("data_mode") == "nse_eod_proxy_scored"),
        ...
        proxy_count = sum(1 for stock in summaries if stock.get("data_mode") == "nse_eod_proxy_scored")
        allowed_full_scan_modes = {"real_nse_scored", "nse_eod_proxy_scored", "nse_dynamic_real", "nse_dynamic_focus"}
        strict_ranked = [
            stock
