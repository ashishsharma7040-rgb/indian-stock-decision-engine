...
DEMO_DASHBOARD.top_weekly_candidates = DEMO_DASHBOARD.stocks.slice(0, 3);
DEMO_DASHBOARD.top_monthly_candidates = [...DEMO_DASHBOARD.stocks].sort((a, b) => b.monthly_score - a.monthly_score).slice(0, 3);
DEMO_DASHBOARD.avoid_list = DEMO_DASHBOARD.stocks.filter(s => s.conviction === "Avoid" || s.risk_score >= 18);
DEMO_DASHBOARD.top_sectors = [
...
DEMO_DASHBOARD.stocks.forEach(stock => {
