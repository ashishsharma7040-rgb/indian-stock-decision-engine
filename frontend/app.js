      ...
      ${renderSettingsSection(
        ...
        `
          <div class="decision-chip-row">
            ...
            ${renderStatusChip(`Connection ${db.connection_test || "unknown"}`, db.connection_test === "ok" ? "green" : db.connection_test === "failed" ? "red" : "amber")}
          </div>
          ${renderSettingsChecklistRow("Database enabled", Boolean(db.enabled), db.error || db.import_error || "")}
          ${renderSettingsChecklistRow("Connection test", db.connection_test === "ok", db.connection_error || db.count_error || "Backend connection test will surface here.")}
